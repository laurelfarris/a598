...
\begin{frame}{Coronal seismology}{Technique and motivation}
    What it is: ``Frozen-in'' magnetic field creates density structures in the
    solar atmosphere, such as loops and prominences. These act as waveguides:
    \begin{itemize}
        \item Observe disturbances
        \item Identify the mode, or type of wave
        \item Insert observed properties into appropriate equations to
            derive coronal parameters, that are otherwise difficult or
            impossible to observe
    \end{itemize}
    Other unknowns:
    \begin{itemize}
        \item How disturbances are initiated, and how they are damped.
...
\begin{frame}{Magnetohydrodynamics (MHD)}{Theory}
    ...
    \end{columns}
\end{frame}%-------------------------------------------------------------%
\begin{frame}{MHD}{What's the difference?}
...
\begin{frame}{Standing oscillations vs.\ propagating waves}
    \begin{itemize}
        ...
        \item Velocity and intensity are 90$^{\circ}$ out of phase
            ...
            acoustic waves. Frequencies less than the cutoff are
            filtered by the chromosphere, no loop shape change or
            displacement, near footpoints
    \end{itemize}
\end{frame}%-------------------------------------------------------------%
...
\begin{frame}{Research}
    %\includegraphics... need full disk and columns here!
\end{frame}%-------------------------------------------------------------%
